...
public class SpecificationTableController implements Controller {
    ...
    private final GridBase gridBase = new GridBase(10, 10);
    private final SpreadsheetView tableView;
    ...
    public SpecificationTableController(GlobalConfig config, ObjectProperty<List<Type>> typeContext,
        ...
        tableView = new SpreadsheetView();
        tableView.setGrid(gridBase);
  ...
  */
        ...
        //.setItems(hybridSpec.getHybridRows());
    }
