...
public class SpecificationTable<H extends Named, C, D> {
    ...
    private ObservableList<String> cHeaders = FXCollections.observableArrayList();
    ...
    public SpecificationTable(Callback<H, Observable[]> columnHeaderExtractor,
        ...
        columnHeaders.addListener((ListChangeListener<H>) c -> {
            cHeaders.setAll(columnHeaders
    ...
    class GridAdapter implements Grid {
        ...
        public void setCellValue(int row, int column, Object value) {
            //TODO
            SpecificationRow<C> r = rows.get(row);
            H c = columnHeaders.get(column);
            r.getCells().get(c.getName());
        }
        ...
        public void setRows(Collection<ObservableList<SpreadsheetCell>> rows) {
            //SpecificationTable.this.rows.setAll(rows);
        }
